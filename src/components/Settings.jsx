...
import { Drawer, Form, Input, InputNumber, Button, Switch, message, Divider, Tag, Space, Select, Checkbox } from 'antd'
...
function Settings() {
  ...
  return (
    <div className="settings-page" style={{ maxWidth: 800, margin: '0 auto', padding: '0 24px 24px' }}>
      {/* 文件夹设置 */}
